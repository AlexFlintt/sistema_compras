        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                    ...
                    $proveedor->check_session();
                ?>
                <div class="card card-body">
                    <form action="proveedor.php" method="POST">
                        <div class="form-group mb-3">
                            <input type="text" name="nombre_ar" class= "form-control" placeholder ="ingrese el nombre del proveedor"
                            autofocus>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>    
                        ...
                        $resultado_ar = $proveedor->resultado($conex);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <!-- Boton de editar -->
                                                <a href=<?php $proveedor->editar($row['3'])?> class= "btn btn-secondary">
                                                    <i class="">Editar</i>
                                                </a> 
                                            </div>
                                                <div class="col-sm-5">
                                                    <!-- Confirmar o negar la eliminacion de un registro-->
                                                        <!-- Boton de eliminar -->
                                                <a href=<?php $proveedor->eliminiar($row['3'])?> class="btn btn-danger">
